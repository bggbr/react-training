...
function Home() {
    ...
    const removeMenu = (menu) => {
        let copyAllMenu = allMenuList.filter((el) => (el.id === menu.id ? false : true));
        ...
        <div>
            <MenuContext.Provider value={allMenuList}>
                <SetMenuContext.Provider value={setAllMenuList}>
                    <Header cookingMenu={cookingMenu} setCookingMenu={setCookingMenu} />
                    <div className="flex">
                        <Category category={category} setCategory={setCategory} />
                        <Menu addMenu={addMenu} removeMenu={removeMenu} category={category} setCookingList={setCookingList} />
                    </div>
